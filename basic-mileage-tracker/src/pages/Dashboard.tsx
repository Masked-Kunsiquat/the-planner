...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6 text-center">Mileage Tracker</h1>
      ...
      <div className="flex justify-center space-x-4 mb-8">
        <button 
          ...
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow-md flex items-center"
        >
        ...
        <button 
          ...
          className="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg shadow-md flex items-center"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
          </svg>
            ...
            <tbody>
              {trips.slice(0, 5).map((trip, index) => (
                <tr key={index} className="border-t">
                  ...
                  <td className="px-4 py-2">{trip.distance.toFixed(1)} miles</td>
