...
// Reusable stat card (moved to ExpensesPage for clarity, or you can keep it in a separate component file)
const StatCard = ({
  icon: Icon,
  title,
  value,
...
const ExpensesPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Stat Cards Grid */}
      <div className="grid grid-cols-3 grid-rows-2 gap-4 mb-8 overflow-x-auto">
        <StatCard
          icon={HiOutlineCash}
          title="TOTAL SPENT"
        ...
        <StatCard
          ...
          title="TOTAL GALLONS"
          value={stats.totalGallons.toFixed(2)}
        />
        <StatCard
          icon={HiOutlineCalculator}
          title="AVG MPG"
          value={stats.avgMpg > 0 ? stats.avgMpg.toFixed(1) : 'N/A'}
        />
        <StatCard
          icon={HiOutlineChartPie}
          title="BEST MPG"
          value={stats.bestMpg > 0 ? stats.bestMpg.toFixed(1) : 'N/A'}
        />
        <StatCard
          icon={HiOutlineBan}
          title="WORST MPG"
          value={stats.worstMpg > 0 ? stats.worstMpg.toFixed(1) : 'N/A'}
        />
        <StatCard
          icon={HiOutlineFire}
          title="FULL TANK FILLUPS"
          value={stats.totalFullTankFillups}
        />
      </div>
